                            ...
                            <tbody>
                                @if(!empty($timetables))
                                  @foreach($timetables as $key=>$timetable)
                                     <tr>
                                          <td>{{$key+1}}</td>
                                          <td>{{$timetable->clas->clas_name}}</td>
                                          <td><?php echo$timetable->time_table;?></td>
                                          <td>
                                            <button class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#updateTimeTable{{$timetable->id}}">
                                                <i class="fa fa-edit"></i> View/Edit
                                            </button>

                                            <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteTimeTable{{$timetable->id}}">
                                        ...
                                        <!-- Add User modal -->
                                            <div id="updateTimeTable{{$timetable->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" action="{{route('updateTimeTable')}}">
                                                            @csrf
                                                            ...
                                                            <div class="card-body">
                                                                 ...
                                                                 <input type="text" name="id" value="{{$timetable->id}}" class="form-control">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select  name="clas_id" class="form-control" required>
                                                                                <option value="{{$timetable->clas_id}}">{{$timetable->clas->clas_name}}</option>
                                                                                @if(!empty($clases))
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="time_table" class="form-control"><?php echo$timetable->time_table;?></textarea>
                                        ...
                                        <!--end of modal-->
                                         ...
                                         <!-- Add User modal -->
                                         <div id="deleteTimeTable{{$timetable->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" action="{{route('deleteTimeTable')}}">
                                                            @csrf
...
<div id="addModule" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form method="post" action="{{route('addTimeTable')}}">
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label>Timetable<sup>*</sup></label>
                                <textarea name="time_table" class="form-control"></textarea>
